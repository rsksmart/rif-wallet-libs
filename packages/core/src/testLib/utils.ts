...
import { getWalletSetting, SETTINGS } from '../../src/config'
import { tenPow } from '../../src/token/BaseToken'
import { ERC20Token } from '../../src/token/ERC20Token'
import { RBTCToken } from '../../src/token/RBTCToken'
import { ERC677__factory } from '../../src/token/types'
