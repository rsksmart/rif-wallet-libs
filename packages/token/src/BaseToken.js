...
exports.tenPow = exports.ten = exports.BaseToken = void 0
const ethers_1 = require('ethers')
const BaseToken = /** @class */ (function () {
  function BaseToken (signer, symbol, logo) {
    this.signer = signer
    this.symbol = symbol
    this.logo = logo
  }
  BaseToken.prototype.getAccountAddress = function () {
...
const tenPow = function (exp) { return exports.ten.pow(exp) }
