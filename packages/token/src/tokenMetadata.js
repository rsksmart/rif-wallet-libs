...
// @ts-ignore
const rsk_contract_metadata_1 = __importDefault(require('@rsksmart/rsk-contract-metadata'))
// @ts-ignore
const rsk_testnet_contract_metadata_1 = __importDefault(require('@rsksmart/rsk-testnet-contract-metadata'))
// @ts-ignore
const RBTC_mainnet_svg_1 = __importDefault(require('./assets/RBTC-mainnet.svg'))
// @ts-ignore
const RBTC_testnet_svg_1 = __importDefault(require('./assets/RBTC-testnet.svg'))
// @ts-ignore
const token_mainnet_svg_1 = __importDefault(require('./assets/token-mainnet.svg'))
// @ts-ignore
const token_testnet_svg_1 = __importDefault(require('./assets/token-testnet.svg'))
const ERC20Token_1 = require('./ERC20Token')
const RBTCToken_1 = require('./RBTCToken')
...
const getTokenLogo = function (address, chainId) {
  const tokensMetadata = chainId === exports.MAINNET_CHAINID ? exports.tokensMetadataMainnet : exports.tokensMetadataTestnet
  const imageBaseUrl = chainId === exports.MAINNET_CHAINID ? exports.imagesUrlMainnet : exports.imagesUrlTestnet
...
const getAllTokens = function (signer) {
  return __awaiter(void 0, void 0, void 0, function () {
    let chainId, metadataTokens, metadataKeys, tokens, rbtc, _i, metadataKeys_1, address, addressWithoutChecksum, symbol, logo, token
...
const convertToERC20Token = function (token, _a) {
  const chainId = _a.chainId; const signer = _a.signer
  const addressWithoutChecksum = token.contractAddress.toLowerCase()
  const logo = (0, exports.getTokenLogo)(addressWithoutChecksum, chainId)
...
const makeRBTCToken = function (signer, chainId) {
  const rbtcLogo = chainId === exports.MAINNET_CHAINID ? RBTC_mainnet_svg_1.default : RBTC_testnet_svg_1.default
  const rbtcSymbol = chainId === exports.MAINNET_CHAINID ? 'RBTC' : 'TRBTC'
  const rbtc = new RBTCToken_1.RBTCToken(signer, rbtcSymbol, rbtcLogo, chainId)
  return rbtc
}
