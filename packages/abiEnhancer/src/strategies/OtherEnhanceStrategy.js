...
const ethList4BytesServiceUrl = 'https://raw.githubusercontent.com/ethereum-lists/4bytes/master/signatures'
const ethList4BytesWithNamesServiceUrl = 'https://raw.githubusercontent.com/ethereum-lists/4bytes/master/with_parameter_names'
const getFunctionSignatures = function (fnHexSig) {
  return __awaiter(void 0, void 0, void 0, function () {
    let functionSignaturePromise, functionSignatureWithNamesPromise
...
const getHexSig = function (data) {
  const firstFourBytes = (0, bytes_1.hexDataSlice)(data, 0, 4)
  const functionHexWithout0x = firstFourBytes.substring(2)
  return functionHexWithout0x
}
const parseSignature = function (signatures) {
...
const parseSignatureWithParametersNames = function (signaturesWithNames, parametersTypes) {
  const INSIDE_PARENTHESIS = 1
  const firstSignature = signaturesWithNames.split(';')[0]
  const parametersExpression = new RegExp(/\((.*)\)/).exec(firstSignature)
  const parametersNames = parametersExpression
    ? parametersExpression[INSIDE_PARENTHESIS].split(',')
    : []
...
const OtherEnhanceStrategy = /** @class */ (function () {
  function OtherEnhanceStrategy () {
  }
  OtherEnhanceStrategy.prototype.parse = function (signer, transactionRequest) {
    return __awaiter(this, void 0, void 0, function () {
      let hexSig, signaturesFounded, _a, signatures, signaturesWithParametersNames, _b, functionName, parametersTypes, parametersNames, parametersValues, result, index, name_1, value
