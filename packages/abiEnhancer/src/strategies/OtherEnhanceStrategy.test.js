...
describe('Other Enhance Strategy', function () {
    ...
    it('should return transaction info enhanced', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    strategy = new OtherEnhanceStrategy_1.OtherEnhanceStrategy();
                ...
                case 1:
                    ...
                    expect(result.to).toBe(testToken === null || testToken === void 0 ? void 0 : testToken.address);
                    expect(result.functionParameters.length).toBeGreaterThan(0);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should return null if data is empty', function () { return __awaiter(void 0, void 0, void 0, function () {
        var strategy, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    strategy = new OtherEnhanceStrategy_1.OtherEnhanceStrategy();
                    return [4 /*yield*/, strategy.parse(accountSigner, __assign(__assign({}, transactionRequest), { data: undefined }))];
                case 1:
                    result = _a.sent();
    ...
    it('should return null if it could not find the method definition', function () { return __awaiter(void 0, void 0, void 0, function () {
        var customFunctionData, strategy, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    customFunctionData = '0xa9959cbb0000000000000000000000001d4f6a5fe927f0e0e4497b91cebfbcf64da1c93400000000000000000000000000000000000000000000000000038d7ea4c68000';
                    strategy = new OtherEnhanceStrategy_1.OtherEnhanceStrategy();
                    return [4 /*yield*/, strategy.parse(accountSigner, __assign(__assign({}, transactionRequest), { data: customFunctionData }))];
                case 1:
                    result = _a.sent();
                    expect(result).toBeNull();
                    return [2 /*return*/];
