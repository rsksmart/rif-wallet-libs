...
describe('ERC20 Enhance Strategy', function () {
    ...
    it('should return transaction info enhanced', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    strategy = new ERC20EnhanceStrategy_1.ERC20EnhanceStrategy();
    ...
    it('should return null if the token is not in the tokens metadata', function () { return __awaiter(void 0, void 0, void 0, function () {
        var strategy, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    strategy = new ERC20EnhanceStrategy_1.ERC20EnhanceStrategy();
                    return [4 /*yield*/, strategy.parse(accountSigner, __assign(__assign({}, transactionRequest), { to: '0xNotExist' }))];
                case 1:
                    result = _a.sent();
                    expect(result).toBeNull();
                    return [2 /*return*/];
