...
exports.RifWalletServicesFetcher = void 0
const RESULTS_LIMIT = 10
const RifWalletServicesFetcher = /** @class */ (function () {
  function RifWalletServicesFetcher (uri) {
    const _this = this
    this.fetchTransactionsByAddress = function (smartAddress, prev, next) {
      let transactionsUrl = _this.uri + '/address/' + smartAddress + '/transactions?limit=' + RESULTS_LIMIT
      if (prev) {
  ...
  return RifWalletServicesFetcher
}())
exports.RifWalletServicesFetcher = RifWalletServicesFetcher
