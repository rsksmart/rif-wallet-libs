...
const ActivityScreen_1 = require('../../screens/activity/ActivityScreen')
const RifWalletServicesSocket = /** @class */ (function (_super) {
  ...
  RifWalletServicesSocket.prototype.init = function (wallet) {
    return __awaiter(this, void 0, void 0, function () {
      let fetchedTransactions, activityTransactions, fetchedTokens
      const _this = this
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [4 /* yield */, Promise.all(fetchedTransactions.data.map(function (tx) {
              return __awaiter(_this, void 0, void 0, function () {
                let enhancedTransaction
                return __generator(this, function (_a) {
                  switch (_a.label) {
