...
var SmartWalletFactory_1 = require("./SmartWalletFactory");
var SmartWallet_1 = require("./SmartWallet");
var filterTxOptions_1 = require("./filterTxOptions");
var RIFWallet = /** @class */ (function (_super) {
    ...
    function RIFWallet(smartWalletFactory, smartWallet, onRequest) {
        ...
        _this.sendTransaction = _this.createDoRequest('sendTransaction', (function (_a, overriddenOptions) {
            var _b;
            var transactionRequest = _a[0];
            var txOptions = __assign(__assign({}, (0, filterTxOptions_1.filterTxOptions)(transactionRequest)), overriddenOptions || {});
    ...
    RIFWallet.create = function (signer, smartWalletFactoryAddress, onRequest) {
        return __awaiter(this, void 0, void 0, function () {
            var smartWalletFactory, smartWalletAddress, smartWallet;
