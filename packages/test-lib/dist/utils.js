...
exports.createNewTestWallet = exports.fundAccount = exports.sendAndWait = exports.rpcAccount = exports.testJsonRpcProvider = void 0;
...
var sendAndWait = function (tx) { return __awaiter(void 0, void 0, void 0, function () {
...
var fundAccount = function (to) { return exports.rpcAccount.sendTransaction({
    to: to,
    value: ethers_1.BigNumber.from('1000000000000000000')
}); };
exports.fundAccount = fundAccount;
var createNewTestWallet = function () { return __awaiter(void 0, void 0, void 0, function () {
    var wallet;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                wallet = ethers_1.Wallet.createRandom().connect(exports.testJsonRpcProvider);
